...
CREATE TABLE "ProgressDay" (
    ...
    CONSTRAINT "ProgressDay_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "ProgressDay" ADD CONSTRAINT "ProgressDay_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
